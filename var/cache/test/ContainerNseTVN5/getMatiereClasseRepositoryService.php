 ...
 */
class getMatiereClasseRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\MatiereClasseRepository' shared autowired service.
     *
     * @return \App\Repository\MatiereClasseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MatiereClasseRepository.php';

        return $container->privates['App\\Repository\\MatiereClasseRepository'] = new \App\Repository\MatiereClasseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
