 ...
 */
class getObjectifSanteRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ObjectifSanteRepository' shared autowired service.
     *
     * @return \App\Repository\ObjectifSanteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ObjectifSanteRepository.php';

        return $container->privates['App\\Repository\\ObjectifSanteRepository'] = new \App\Repository\ObjectifSanteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
