...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\FrontGroupeProjetController' => 'getFrontGroupeProjetControllerService',
            'App\\Controller\\FrontObjectifSanteController' => 'getFrontObjectifSanteControllerService',
            'App\\Controller\\FrontSuiviBienEtreController' => 'getFrontSuiviBienEtreControllerService',
            'App\\Controller\\GroupeProjetController' => 'getGroupeProjetControllerService',
            'App\\Controller\\MatiereClasseController' => 'getMatiereClasseControllerService',
            'App\\Controller\\ObjectifSanteController' => 'getObjectifSanteControllerService',
            'App\\Controller\\ObjectifSuiviBienEtreController' => 'getObjectifSuiviBienEtreControllerService',
            'App\\Controller\\PreferenceAlerteController' => 'getPreferenceAlerteControllerService',
            'App\\Controller\\PropositionReunionController' => 'getPropositionReunionControllerService',
            'App\\Controller\\QuizAdminController' => 'getQuizAdminControllerService',
            ...
            'App\\Controller\\SuiviTacheController' => 'getSuiviTacheControllerService',
    ...
    {
        return $container->services['doctrine.dbal.default_connection'] = ($container->privates['doctrine.dbal.connection_factory'] ?? self::getDoctrine_Dbal_ConnectionFactoryService($container))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'use_savepoints' => true, 'dbname_suffix' => '_test'.$container->getEnv('string:default::TEST_TOKEN'), 'driver' => 'pdo_mysql', 'idle_connection_ttl' => 600, 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], ($container->privates['doctrine.dbal.default_connection.configuration'] ?? self::getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)), NULL, []);
    }
    ...
    {
        return $container->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hSr1r6XtRQ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NILynLrd72', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.asset_mapper.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lylfD7KMXK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ydp1tIs9+z', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GfC7ScZNy8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BhT9jXOAEz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pnxOO83FSW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KyILAtNOaC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nKaWFin4cP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fKT9MWlWIk', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ni3w26nlTG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5TtEa3rq+Y', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getChartjs_TwigExtensionService($container)
    {
        ...
        $instance = new \Symfony\UX\Chartjs\Twig\ChartExtension($a);

        if (isset($container->privates['chartjs.twig_extension'])) {
            return $container->privates['chartjs.twig_extension'];
        }

        return $container->privates['chartjs.twig_extension'] = $instance;
    }
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\ClasseController', 'App\\Controller\\FrontGroupeProjetController', 'App\\Controller\\FrontObjectifSanteController', 'App\\Controller\\FrontSuiviBienEtreController', 'App\\Controller\\GroupeProjetController', 'App\\Controller\\MatiereClasseController', 'App\\Controller\\ObjectifSanteController', 'App\\Controller\\ObjectifSuiviBienEtreController', 'App\\Controller\\PreferenceAlerteController', 'App\\Controller\\PropositionReunionController', 'App\\Controller\\QuizAdminController', 'App\\Controller\\QuizController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ResetPasswordController', 'App\\Controller\\SalleController', 'App\\Controller\\SeanceController', 'App\\Controller\\SecurityController', 'App\\Controller\\SuiviTacheController', 'App\\Controller\\TacheController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Orm_ContainerRepositoryFactoryService($container)
    {
        return $container->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\GroupeProjetRepository' => ['privates', 'App\\Repository\\GroupeProjetRepository', 'getGroupeProjetRepositoryService', true],
            'App\\Repository\\MatiereClasseRepository' => ['privates', 'App\\Repository\\MatiereClasseRepository', 'getMatiereClasseRepositoryService', true],
            'App\\Repository\\ObjectifSanteRepository' => ['privates', 'App\\Repository\\ObjectifSanteRepository', 'getObjectifSanteRepositoryService', true],
            'App\\Repository\\PreferenceAlerteRepository' => ['privates', 'App\\Repository\\PreferenceAlerteRepository', 'getPreferenceAlerteRepositoryService', true],
            'App\\Repository\\PropositionReunionRepository' => ['privates', 'App\\Repository\\PropositionReunionRepository', 'getPropositionReunionRepositoryService', true],
            'App\\Repository\\QuizAttemptDetailRepository' => ['privates', 'App\\Repository\\QuizAttemptDetailRepository', 'getQuizAttemptDetailRepositoryService', true],
            'App\\Repository\\QuizAttemptRepository' => ['privates', 'App\\Repository\\QuizAttemptRepository', 'getQuizAttemptRepositoryService', true],
            'App\\Repository\\QuizQuestionRepository' => ['privates', 'App\\Repository\\QuizQuestionRepository', 'getQuizQuestionRepositoryService', true],
            ...
            'App\\Repository\\SuiviBienEtreRepository' => ['privates', 'App\\Repository\\SuiviBienEtreRepository', 'getSuiviBienEtreRepositoryService', true],
            'App\\Repository\\SuiviTacheRepository' => ['privates', 'App\\Repository\\SuiviTacheRepository', 'getSuiviTacheRepositoryService', true],
            ...
            'App\\Repository\\GroupeProjetRepository' => '?',
            'App\\Repository\\MatiereClasseRepository' => '?',
            'App\\Repository\\ObjectifSanteRepository' => '?',
            'App\\Repository\\PreferenceAlerteRepository' => '?',
            'App\\Repository\\PropositionReunionRepository' => '?',
            'App\\Repository\\QuizAttemptDetailRepository' => '?',
            'App\\Repository\\QuizAttemptRepository' => '?',
            ...
            'App\\Repository\\SuiviBienEtreRepository' => '?',
            'App\\Repository\\SuiviTacheRepository' => '?',
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'profile_pics_directory' => (\dirname(__DIR__, 4).'/public/uploads/profile_pics'),
