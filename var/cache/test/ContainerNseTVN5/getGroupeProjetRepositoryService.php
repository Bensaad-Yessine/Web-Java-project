 ...
 */
class getGroupeProjetRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\GroupeProjetRepository' shared autowired service.
     *
     * @return \App\Repository\GroupeProjetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GroupeProjetRepository.php';

        return $container->privates['App\\Repository\\GroupeProjetRepository'] = new \App\Repository\GroupeProjetRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
