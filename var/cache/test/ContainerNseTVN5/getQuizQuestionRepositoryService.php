 ...
 */
class getQuizQuestionRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuizQuestionRepository' shared autowired service.
     *
     * @return \App\Repository\QuizQuestionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuizQuestionRepository.php';

        return $container->privates['App\\Repository\\QuizQuestionRepository'] = new \App\Repository\QuizQuestionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
