 ...
 */
class getPropositionReunionRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\PropositionReunionRepository' shared autowired service.
     *
     * @return \App\Repository\PropositionReunionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PropositionReunionRepository.php';

        return $container->privates['App\\Repository\\PropositionReunionRepository'] = new \App\Repository\PropositionReunionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
