 ...
 */
class getQuizAttemptDetailRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuizAttemptDetailRepository' shared autowired service.
     *
     * @return \App\Repository\QuizAttemptDetailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuizAttemptDetailRepository.php';

        return $container->privates['App\\Repository\\QuizAttemptDetailRepository'] = new \App\Repository\QuizAttemptDetailRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
