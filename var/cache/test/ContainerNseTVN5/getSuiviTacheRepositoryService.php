 ...
 */
class getSuiviTacheRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\SuiviTacheRepository' shared autowired service.
     *
     * @return \App\Repository\SuiviTacheRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SuiviTacheRepository.php';

        return $container->privates['App\\Repository\\SuiviTacheRepository'] = new \App\Repository\SuiviTacheRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
