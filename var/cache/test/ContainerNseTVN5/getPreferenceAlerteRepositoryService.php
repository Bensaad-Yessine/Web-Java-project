 ...
 */
class getPreferenceAlerteRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\PreferenceAlerteRepository' shared autowired service.
     *
     * @return \App\Repository\PreferenceAlerteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PreferenceAlerteRepository.php';

        return $container->privates['App\\Repository\\PreferenceAlerteRepository'] = new \App\Repository\PreferenceAlerteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
