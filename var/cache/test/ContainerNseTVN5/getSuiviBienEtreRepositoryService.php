 ...
 */
class getSuiviBienEtreRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\SuiviBienEtreRepository' shared autowired service.
     *
     * @return \App\Repository\SuiviBienEtreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SuiviBienEtreRepository.php';

        return $container->privates['App\\Repository\\SuiviBienEtreRepository'] = new \App\Repository\SuiviBienEtreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
