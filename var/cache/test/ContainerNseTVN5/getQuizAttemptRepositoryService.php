 ...
 */
class getQuizAttemptRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuizAttemptRepository' shared autowired service.
     *
     * @return \App\Repository\QuizAttemptRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuizAttemptRepository.php';

        return $container->privates['App\\Repository\\QuizAttemptRepository'] = new \App\Repository\QuizAttemptRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
