 ...
 */
class get_ServiceLocator_YE_U6HBService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.YE.U6HB'])) {
            return $container->privates['.service_locator.YE.U6HB'];
        }

        return $container->privates['.service_locator.YE.U6HB'] = $instance;
    }
}
