...
class __TwigTemplate_85a1b9e0ca1b0d5adda5203c33539ff8 extends Template
{
    ...
    <div class=\"container-fluid page-body-wrapper\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["matiere_classe"]) {
                ...
                yield "%\"></div>
                                ...
                                <td>
                                  <a href=\"";
                // line 710
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_quiz_matiere", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["matiere_classe"], "id", [], "any", false, false, false, 710)]), "html", null, true);
                yield "\" class=\"btn btn-success btn-sm btn-icon\" title=\"Gérer le quiz\">
                                ...
                                <td>
                                  <div class=\"action-buttons\">
                                    <a href=\"";
                // line 716
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_matiere_classe_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["matiere_classe"], "id", [], "any", false, false, false, 716)]), "html", null, true);
                yield "\" class=\"btn btn-info btn-sm btn-icon\" title=\"Voir\">
                                      <i class=\"mdi mdi-eye\"></i>
                                    </a>
                                    <a href=\"";
                // line 719
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_matiere_classe_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["matiere_classe"], "id", [], "any", false, false, false, 719)]), "html", null, true);
                yield "\" class=\"btn btn-warning btn-sm btn-icon\" title=\"Modifier\">
                                    ...
                                    <button type=\"button\" class=\"btn btn-danger btn-sm btn-icon delete-btn\" 
                                            data-matiere-id=\"";
                // line 723
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["matiere_classe"], "id", [], "any", false, false, false, 723), "html", null, true);
                yield "\" 
                                            data-matiere-name=\"";
                // line 724
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["matiere_classe"], "nom", [], "any", false, false, false, 724), "html", null, true);
                yield "\" 
                                            data-csrf-token=\"";
                // line 725
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, $context["matiere_classe"], "id", [], "any", false, false, false, 725))), "html", null, true);
                yield "\"
                                            title=\"Supprimer\">
        ...
        yield " ESPRIT École d'Ingénieurs. Tous droits réservés.
                ...
                <span class=\"text-muted float-none float-sm-end d-block mt-1 mt-sm-0 text-center\">
                  Gestion des Matières - ";
        // line 749
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["matiere_classes"]) || array_key_exists("matiere_classes", $context) ? $context["matiere_classes"] : (function () { throw new RuntimeError('Variable "matiere_classes" does not exist.', 749, $this->source); })())), "html", null, true);
        yield " matières
                </span>
              </div>
            </footer>
            ...
            .then(data => {
              ...
              if (data.success) {
                ...
                if (tbody) {
                    tbody.innerHTML = '';
                    if (data.count === 0) {
                        tbody.innerHTML = '<tr><td colspan=\"6\" class=\"text-center text-muted py-5\"><i class=\"mdi mdi-alert-circle-outline display-4 mb-3 d-block\"></i><h4>Aucune matière trouvée</h4><p>Essayez de modifier vos critères de recherche</p></td></tr>';
                    } else {
