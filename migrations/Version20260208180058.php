...
final class Version20260208180058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS classe (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, niveau VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS groupe_projet (id INT AUTO_INCREMENT NOT NULL, groupe_id INT NOT NULL, nom_projet VARCHAR(255) NOT NULL, matiere VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS groupe_projet_user (groupe_projet_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_759C4AA850555145 (groupe_projet_id), INDEX IDX_759C4AA8A76ED395 (user_id), PRIMARY KEY (groupe_projet_id, user_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS matiere_classe (id INT AUTO_INCREMENT NOT NULL, coefficient DOUBLE PRECISION NOT NULL, chargehoraire INT NOT NULL, scorecomplexite INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS matiere_classe_classe (matiere_classe_id INT NOT NULL, classe_id INT NOT NULL, INDEX IDX_39E20BE64A50F62F (matiere_classe_id), INDEX IDX_39E20BE68F5EA509 (classe_id), PRIMARY KEY (matiere_classe_id, classe_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS objectif_sante (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(30) NOT NULL, valeur_cible INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, statut VARCHAR(20) NOT NULL, priorite VARCHAR(10) DEFAULT NULL, progression DOUBLE PRECISION DEFAULT NULL, titre VARCHAR(100) NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_C21403AFA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS preference_alerte (id INT AUTO_INCREMENT NOT NULL, email_actif TINYINT NOT NULL, push_actif TINYINT NOT NULL, site_notif_active TINYINT NOT NULL, delai_rappel_min INT NOT NULL, delai_urgent_heures INT NOT NULL, freaquence_max_par_jour INT NOT NULL, heure_silence_debut DATETIME NOT NULL, heure_silence_fin DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS proposition_reunion (id INT AUTO_INCREMENT NOT NULL, proposition_id INT NOT NULL, titre VARCHAR(255) NOT NULL, date_reunion DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, lieu VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, nbr_vote_accept INT DEFAULT NULL, id_groupe_id INT NOT NULL, INDEX IDX_FF570D6DFA7089AB (id_groupe_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS salle (id INT AUTO_INCREMENT NOT NULL, block VARCHAR(1) NOT NULL, number INT NOT NULL, name VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS seance (id INT AUTO_INCREMENT NOT NULL, matiere VARCHAR(20) NOT NULL, jour VARCHAR(10) NOT NULL, type_seance VARCHAR(15) NOT NULL, mode VARCHAR(15) NOT NULL, salle_id INT NOT NULL, INDEX IDX_DF7DFD0EDC304035 (salle_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS suivi_bien_etre (id INT AUTO_INCREMENT NOT NULL, date_saisie DATE NOT NULL, humeur VARCHAR(255) NOT NULL, qualite_sommeil INT NOT NULL, niveau_energie INT NOT NULL, niveau_stress INT NOT NULL, qualite_alimentation INT NOT NULL, notes_libres LONGTEXT DEFAULT NULL, score DOUBLE PRECISION DEFAULT NULL, objectif_id INT NOT NULL, INDEX IDX_1C7AE11E157D1AD4 (objectif_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS tache (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, duree_estimee INT NOT NULL, priorite VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, origine VARCHAR(255) NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_93872075A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE IF NOT EXISTS `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, num_tel VARCHAR(20) DEFAULT NULL, date_de_naissance DATE NOT NULL, sexe VARCHAR(10) NOT NULL, profile_pic VARCHAR(255) DEFAULT NULL, classe_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6498F5EA509 (classe_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
